...
export function LocationFilter({
  availableLocations, selectedCount, recentLocations,
  toggleLocation, isLocationSelected, pillScroll, listScroll,
}: LocationFilterProps) {
  return (
    <details>
      <summary className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 cursor-pointer flex items-center gap-2 min-w-0">
        <span className="flex-shrink-0 flex items-center gap-1">
          ...
          Locations {selectedCount > 0 && `(${selectedCount} selected)`}
        </span>
