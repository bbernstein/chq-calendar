...
export const WEB_SCENARIOS: Scenario[] = [
  {
    ...
    body: [
      'The whole season is on one page, day by day. There is no date filter to set and no window to widen — every date is already there, and getting to the one you want is a matter of moving rather than filtering.',
      'The day strip along the top is how you move. It follows whichever day you have scrolled to; tap another day to jump straight there.',
      'Above the days, the week band shows which week each stretch of dates belongs to — tap it to move a week at a time, or open the week chooser to pick any week of the season. Wander off today and an outlined chip carrying today’s date appears at the end of the strip; tap it to come straight back.',
    ],
  ...
  },
  {
    ...
    title: 'Follow the season',
    body: [
      'The week band above the day strip, and the week chooser beside it, move you through the season a week at a time. Neither one filters anything — the whole season stays listed, and you are simply somewhere else in it.',
...
export const WEB_FEATURES: Feature[] = [
  ...
  // Dates & weeks
  { id: 'web-whole-season', group: 'Dates & weeks', title: 'The whole season, on one page',
    blurb: 'There is no date filter and no scope to pick. Every day of the season is listed; which part of it you are looking at is where you have scrolled to, not something you set.' },
  { id: 'web-day-rail', group: 'Dates & weeks', title: 'A day strip across the top of the list', notObvious: true,
    blurb: 'A strip of days that highlights whichever day you have scrolled to. Tap a day with something on it to jump there. Empty days are shown but can’t be tapped.' },
  { id: 'web-week-band', group: 'Dates & weeks', title: 'A week band above the days', notObvious: true,
    blurb: 'The strip is banded by season week, so you can see which week any stretch of dates belongs to. Tap a band to move to that week — it moves you, it does not filter.' },
  { id: 'web-week-chooser', group: 'Dates & weeks', title: 'A week chooser for the whole season', notObvious: true,
    blurb: 'Beside the day strip, a grid of every week of the season. Pick one to go there; weeks with nothing matching your filters are dimmed rather than hidden.' },
  { id: 'web-go-to-today', group: 'Dates & weeks', title: 'A dated chip takes you back to today', notObvious: true,
    blurb: 'Wander away from today and an outlined chip showing today’s date appears at the end of the day strip. One tap returns you there without changing a single filter — and while you are already on today, it stays out of the way.' },
  { id: 'web-filters-toggle', group: 'Finding', title: 'A funnel in the header opens the filters', notObvious: true,
