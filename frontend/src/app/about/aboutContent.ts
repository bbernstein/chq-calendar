...
export const WEB_SCENARIOS: Scenario[] = [
  {
    ...
    body: [
      ...
      'Above the days, the week band shows which week each stretch of dates belongs to — tap it to move a week at a time, or open the week chooser to pick any week of the season. ⟳ Now brings you back to today.',
    ],
