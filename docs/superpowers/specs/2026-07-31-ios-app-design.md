...
- **Search:** case-insensitive weighted scoring — title 100, location 90, tags/categories 85 each, description 50, presenter 25, plus per-word bonuses (words > 2 chars: 10/9/7/5/3) — results ordered by score; empty search restores chronological grouping. 200 ms debounce.
